...
file_calls.o: ${S}/userprog/file_calls.c
	${COMPILE.c} ${S}/userprog/file_calls.c
SRCS+=${S}/userprog/file_calls.c
OBJS+=file_calls.o

process_calls.o: ${S}/userprog/process_calls.c
	${COMPILE.c} ${S}/userprog/process_calls.c
SRCS+=${S}/userprog/process_calls.c
OBJS+=process_calls.o
